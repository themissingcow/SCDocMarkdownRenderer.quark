 ...
 *
 * A schelp renderer that generates Markdown formatted output.
 *
 * This is a shameless copy-paste-tweak of the SCDocHTMLRenderer from
 * the main repository. It is currently a work-in-progress to support
 * bridging schelp into Language Server Protocol implementations. It
 * does not currently support producing a full interlinked doc bundle.
 */
